...
I am **`Abhisek Pandey`** 🧔🏻‍♂️. I am from **Berhampur, Odisha** and completed my **B.Tech** from **`Gandhi Institute for Education and Technology, Baniatangi`**. I love to explore and learn about new things. Always find my self in unusal place, where i should not be. I wont brag that **`I like challenges`** but though would brag that **`either I Ace`** on it or **`Learn from it.`**. 

People who knows me, would define me as a **`Trustworth`**, **`Calm`**, **`Accompliser`**, and out of all these thing, one thing that I must know is for having a **`friendly and great personality`**, I might have a few of the **`bad characteristic`** but as said by **`Edwin Rolfe`** - **You can never tell a book by its cover**.
